...
Idx Name          Size      VMA               LMA               File off  Algn
 ...
 22 .got.plt      00000030  0000000000601000  0000000000601000  00001000  2**3
                  CONTENTS, ALLOC, LOAD, DATA
 23 .data         0000002a  0000000000601030  0000000000601030  00001030  2**3
                  CONTENTS, ALLOC, LOAD, DATA
 24 .bss          00000006  000000000060105a  000000000060105a  0000105a  2**0
                  ALLOC
 25 .comment      0000002b  0000000000000000  0000000000000000  0000105a  2**0
                  CONTENTS, READONLY
 26 .debug_aranges 00000030  0000000000000000  0000000000000000  00001090  2**4
                  CONTENTS, READONLY, DEBUGGING
 27 .debug_info   00000074  0000000000000000  0000000000000000  000010c0  2**0
                  CONTENTS, READONLY, DEBUGGING
 28 .debug_abbrev 00000014  0000000000000000  0000000000000000  00001134  2**0
                  CONTENTS, READONLY, DEBUGGING
 29 .debug_line   0000004d  0000000000000000  0000000000000000  00001148  2**0
                  CONTENTS, READONLY, DEBUGGING
SYMBOL TABLE:
...
000000000060105a l    d  .bss	0000000000000000              .bss
...
000000000060105a l     O .bss	0000000000000001              completed.6973
0000000000600e18 l     O .fini_array	0000000000000000              __do_global_dtors_aux_fini_array_entry
0000000000400500 l     F .text	0000000000000000              frame_dummy
0000000000600e10 l     O .init_array	0000000000000000              __frame_dummy_init_array_entry
0000000000000000 l    df *ABS*	0000000000000000              /tmp/cceDTZNy.o
0000000000601040 l       .data	0000000000000000              hello_world_message
0000000000400538 l       .text	0000000000000000              loop
0000000000000000 l    df *ABS*	0000000000000000              crtstuff.c
...
000000000060105a g       .data	0000000000000000              _edata
...
000000000060105a g       .bss	0000000000000000              __bss_start
...
0000000000400470 <deregister_tm_clones>:
  400470:	b8 67 10 60 00       	mov    eax,0x601067
  400475:	55                   	push   rbp
  400476:	48 2d 60 10 60 00    	sub    rax,0x601060
  ...
  400491:	5d                   	pop    rbp
  400492:	bf 60 10 60 00       	mov    edi,0x601060
  400497:	ff e0                	jmp    rax
  400499:	0f 1f 80 00 00 00 00 	nop    DWORD PTR [rax+0x0]

00000000004004a0 <register_tm_clones>:
  4004a0:	b8 60 10 60 00       	mov    eax,0x601060
  4004a5:	55                   	push   rbp
  4004a6:	48 2d 60 10 60 00    	sub    rax,0x601060
  ...
  4004d2:	bf 60 10 60 00       	mov    edi,0x601060
  4004d7:	ff e2                	jmp    rdx
  4004d9:	0f 1f 80 00 00 00 00 	nop    DWORD PTR [rax+0x0]

00000000004004e0 <__do_global_dtors_aux>:
  4004e0:	80 3d 73 0b 20 00 00 	cmp    BYTE PTR [rip+0x200b73],0x0        # 60105a <_edata>
  4004e7:	75 11                	jne    4004fa <__do_global_dtors_aux+0x1a>
  4004e9:	55                   	push   rbp
  4004ea:	48 89 e5             	mov    rbp,rsp
  4004ed:	e8 7e ff ff ff       	call   400470 <deregister_tm_clones>
  4004f2:	5d                   	pop    rbp
  4004f3:	c6 05 60 0b 20 00 01 	mov    BYTE PTR [rip+0x200b60],0x1        # 60105a <_edata>
...
000000000040052d <main>:
  ...
  400531:	49 c7 c4 20 00 00 00 	mov    r12,0x20

0000000000400538 <loop>:
  400538:	48 c7 c7 40 10 60 00 	mov    rdi,0x601040
  40053f:	4c 89 e6             	mov    rsi,r12
  400542:	4c 89 e2             	mov    rdx,r12
  400545:	4c 89 e1             	mov    rcx,r12
  400548:	30 c0                	xor    al,al
  40054a:	e8 c1 fe ff ff       	call   400410 <printf@plt>
  40054f:	49 ff c4             	inc    r12
  400552:	49 83 fc 7f          	cmp    r12,0x7f
  400556:	75 e0                	jne    400538 <loop>

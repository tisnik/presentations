...
Idx Name          Size      VMA               LMA               File off  Algn
 ...
 22 .got.plt      00000030  0000000000601000  0000000000601000  00001000  2**3
                  CONTENTS, ALLOC, LOAD, DATA
 23 .data         00000021  0000000000601030  0000000000601030  00001030  2**3
                  CONTENTS, ALLOC, LOAD, DATA
 24 .bss          00000007  0000000000601051  0000000000601051  00001051  2**0
                  ALLOC
 25 .comment      0000002b  0000000000000000  0000000000000000  00001051  2**0
                  CONTENTS, READONLY
 26 .debug_aranges 00000030  0000000000000000  0000000000000000  00001080  2**4
                  CONTENTS, READONLY, DEBUGGING
 27 .debug_info   0000007b  0000000000000000  0000000000000000  000010b0  2**0
                  CONTENTS, READONLY, DEBUGGING
 28 .debug_abbrev 00000014  0000000000000000  0000000000000000  0000112b  2**0
                  CONTENTS, READONLY, DEBUGGING
 29 .debug_line   00000048  0000000000000000  0000000000000000  0000113f  2**0
                  CONTENTS, READONLY, DEBUGGING
SYMBOL TABLE:
...
0000000000601051 l    d  .bss	0000000000000000              .bss
...
0000000000601051 l     O .bss	0000000000000001              completed.6973
0000000000600e18 l     O .fini_array	0000000000000000              __do_global_dtors_aux_fini_array_entry
0000000000400500 l     F .text	0000000000000000              frame_dummy
0000000000600e10 l     O .init_array	0000000000000000              __frame_dummy_init_array_entry
0000000000000000 l    df *ABS*	0000000000000000              /tmp/ccficGnz.o
...
0000000000601051 g       .data	0000000000000000              _edata
...
0000000000601051 g       .bss	0000000000000000              __bss_start
...
0000000000400470 <deregister_tm_clones>:
  400470:	b8 5f 10 60 00       	mov    eax,0x60105f
  400475:	55                   	push   rbp
  400476:	48 2d 58 10 60 00    	sub    rax,0x601058
  ...
  400491:	5d                   	pop    rbp
  400492:	bf 58 10 60 00       	mov    edi,0x601058
  400497:	ff e0                	jmp    rax
  400499:	0f 1f 80 00 00 00 00 	nop    DWORD PTR [rax+0x0]

00000000004004a0 <register_tm_clones>:
  4004a0:	b8 58 10 60 00       	mov    eax,0x601058
  4004a5:	55                   	push   rbp
  4004a6:	48 2d 58 10 60 00    	sub    rax,0x601058
  ...
  4004d2:	bf 58 10 60 00       	mov    edi,0x601058
  4004d7:	ff e2                	jmp    rdx
  4004d9:	0f 1f 80 00 00 00 00 	nop    DWORD PTR [rax+0x0]

00000000004004e0 <__do_global_dtors_aux>:
  4004e0:	80 3d 6a 0b 20 00 00 	cmp    BYTE PTR [rip+0x200b6a],0x0        # 601051 <_edata>
  4004e7:	75 11                	jne    4004fa <__do_global_dtors_aux+0x1a>
  4004e9:	55                   	push   rbp
  4004ea:	48 89 e5             	mov    rbp,rsp
  4004ed:	e8 7e ff ff ff       	call   400470 <deregister_tm_clones>
  4004f2:	5d                   	pop    rbp
  4004f3:	c6 05 57 0b 20 00 01 	mov    BYTE PTR [rip+0x200b57],0x1        # 601051 <_edata>
...
000000000040052d <main>:
  ...
  400538:	48 c7 c6 2a 00 00 00 	mov    rsi,0x2a
  40053f:	48 c7 c2 2a 00 00 00 	mov    rdx,0x2a
  400546:	30 c0                	xor    al,al
  400548:	e8 c3 fe ff ff       	call   400410 <printf@plt>
  40054d:	48 83 c4 08          	add    rsp,0x8
  400551:	31 c0                	xor    eax,eax
  400553:	c3                   	ret    
  400554:	66 2e 0f 1f 84 00 00 	nop    WORD PTR cs:[rax+rax*1+0x0]
  40055b:	00 00 00 

...
Idx Name          Size      VMA       LMA       File off  Algn
 ...
 12 .plt          00000038  000082ac  000082ac  000002ac  2**2
                  CONTENTS, ALLOC, LOAD, READONLY, CODE
 13 .text         0000011c  000082e4  000082e4  000002e4  2**2
                  CONTENTS, ALLOC, LOAD, READONLY, CODE
 14 .fini         00000008  00008400  00008400  00000400  2**2
                  CONTENTS, ALLOC, LOAD, READONLY, CODE
 15 .rodata       00000004  00008408  00008408  00000408  2**2
                  CONTENTS, ALLOC, LOAD, READONLY, DATA
 16 .ARM.exidx    00000008  0000840c  0000840c  0000040c  2**2
                  CONTENTS, ALLOC, LOAD, READONLY, DATA
 17 .eh_frame     00000004  00008414  00008414  00000414  2**2
                  CONTENTS, ALLOC, LOAD, READONLY, DATA
 18 .init_array   00000004  00010418  00010418  00000418  2**2
                  CONTENTS, ALLOC, LOAD, DATA
 19 .fini_array   00000004  0001041c  0001041c  0000041c  2**2
                  CONTENTS, ALLOC, LOAD, DATA
 20 .jcr          00000004  00010420  00010420  00000420  2**2
                  CONTENTS, ALLOC, LOAD, DATA
 21 .dynamic      000000f0  00010424  00010424  00000424  2**2
                  CONTENTS, ALLOC, LOAD, DATA
 22 .got          0000001c  00010514  00010514  00000514  2**2
                  CONTENTS, ALLOC, LOAD, DATA
 23 .data         00000008  00010530  00010530  00000530  2**2
                  CONTENTS, ALLOC, LOAD, DATA
 24 .bss          00000004  00010538  00010538  00000538  2**0
                  ALLOC
 25 .comment      00000022  00000000  00000000  00000538  2**0
                  CONTENTS, READONLY
 26 .ARM.attributes 0000002d  00000000  00000000  0000055a  2**0
                  CONTENTS, READONLY
SYMBOL TABLE:
...
00008400 l    d  .fini	00000000              .fini
00008408 l    d  .rodata	00000000              .rodata
0000840c l    d  .ARM.exidx	00000000              .ARM.exidx
00008414 l    d  .eh_frame	00000000              .eh_frame
00010418 l    d  .init_array	00000000              .init_array
0001041c l    d  .fini_array	00000000              .fini_array
00010420 l    d  .jcr	00000000              .jcr
00010424 l    d  .dynamic	00000000              .dynamic
00010514 l    d  .got	00000000              .got
00010530 l    d  .data	00000000              .data
00010538 l    d  .bss	00000000              .bss
...
00010420 l     O .jcr	00000000              __JCR_LIST__
00008344 l     F .text	00000000              __do_global_dtors_aux
00010538 l     O .bss	00000001              completed.5637
0001041c l     O .fini_array	00000000              __do_global_dtors_aux_fini_array_entry
00008360 l     F .text	00000000              frame_dummy
00010418 l     O .init_array	00000000              __frame_dummy_init_array_entry
00000000 l    df *ABS*	00000000              /tmp/cc1wkT5U.o
00000000 l    df *ABS*	00000000              elf-init.oS
00000000 l    df *ABS*	00000000              crtstuff.c
00008414 l     O .eh_frame	00000000              __FRAME_END__
00010420 l     O .jcr	00000000              __JCR_END__
00000000 l    df *ABS*	00000000              
0001041c l       .init_array	00000000              __init_array_end
00010424 l     O .dynamic	00000000              _DYNAMIC
00010418 l       .init_array	00000000              __init_array_start
00010514 l     O .got	00000000              _GLOBAL_OFFSET_TABLE_
000083fc g     F .text	00000004              __libc_csu_fini
00010530  w      .data	00000000              data_start
00010538 g       .bss	00000000              __bss_start__
0001053c g       .bss	00000000              _bss_end__
00010538 g       .data	00000000              _edata
00008400 g     F .fini	00000000              _fini
0001053c g       .bss	00000000              __bss_end__
00010530 g       .data	00000000              __data_start
00000000       F *UND*	00000000              __libc_start_main@@GLIBC_2.4
00000000  w      *UND*	00000000              __gmon_start__
00010534 g     O .data	00000000              .hidden __dso_handle
00008408 g     O .rodata	00000004              _IO_stdin_used
0000839c g     F .text	00000060              __libc_csu_init
0001053c g       .bss	00000000              _end
000082e4 g     F .text	00000000              _start
0001053c g       .bss	00000000              __end__
00010538 g       .bss	00000000              __bss_start
...
000082e4 <_start>:
    ...
    8314:	000083fc 	.word	0x000083fc
    8318:	00008390 	.word	0x00008390
    831c:	0000839c 	.word	0x0000839c
...
0000839c <__libc_csu_init>:
    839c:	e92d45f8 	push	{r3, r4, r5, r6, r7, r8, sl, lr}
    83a0:	e1a06000 	mov	r6, r0
    83a4:	e59f5048 	ldr	r5, [pc, #72]	; 83f4 <__libc_csu_init+0x58>
    83a8:	e59fa048 	ldr	sl, [pc, #72]	; 83f8 <__libc_csu_init+0x5c>
    83ac:	e08f5005 	add	r5, pc, r5
    83b0:	e08fa00a 	add	sl, pc, sl
    83b4:	e065a00a 	rsb	sl, r5, sl
    83b8:	e1a07001 	mov	r7, r1
    83bc:	e1a08002 	mov	r8, r2
    83c0:	ebffffb6 	bl	82a0 <_init>
    83c4:	e1b0a14a 	asrs	sl, sl, #2
    83c8:	08bd85f8 	popeq	{r3, r4, r5, r6, r7, r8, sl, pc}
    83cc:	e3a04000 	mov	r4, #0
    83d0:	e4953004 	ldr	r3, [r5], #4
    83d4:	e1a00006 	mov	r0, r6
    83d8:	e1a01007 	mov	r1, r7
    83dc:	e1a02008 	mov	r2, r8
    83e0:	e2844001 	add	r4, r4, #1
    83e4:	e12fff33 	blx	r3
    83e8:	e154000a 	cmp	r4, sl
    83ec:	1afffff7 	bne	83d0 <__libc_csu_init+0x34>
    83f0:	e8bd85f8 	pop	{r3, r4, r5, r6, r7, r8, sl, pc}
    83f4:	00008064 	.word	0x00008064
    83f8:	00008064 	.word	0x00008064

000083fc <__libc_csu_fini>:
    83fc:	e12fff1e 	bx	lr

Disassembly of section .fini:

00008400 <_fini>:
    8400:	e92d4008 	push	{r3, lr}
    8404:	e8bd8008 	pop	{r3, pc}

...
class MainWindow(QtGui.QMainWindow):
    ...
    def drawOverlappingSquares(self, qPainter):
        ...
        # vykreslení sady překrývajících se čtverců
        twoOverlappingSquares(qPainter, GREEN, BLUE_50_ALPHA, COLUMN_1, ROW_1,
                              QtGui.QPainter.CompositionMode_SourceOver)

        twoOverlappingSquares(qPainter, GREEN, BLUE_50_ALPHA, COLUMN_1, ROW_2,
                              QtGui.QPainter.RasterOp_SourceOrDestination)

        twoOverlappingSquares(qPainter, GREEN, BLUE_50_ALPHA, COLUMN_2, ROW_2,
                              QtGui.QPainter.RasterOp_SourceAndDestination)

        twoOverlappingSquares(qPainter, GREEN, BLUE_50_ALPHA, COLUMN_3, ROW_2,
                              QtGui.QPainter.RasterOp_SourceXorDestination)

        twoOverlappingSquares(qPainter, GREEN, BLUE_50_ALPHA, COLUMN_1, ROW_3,
                              QtGui.QPainter.RasterOp_NotSourceAndNotDestination)

        twoOverlappingSquares(qPainter, GREEN, BLUE_50_ALPHA, COLUMN_2, ROW_3,
                              QtGui.QPainter.RasterOp_NotSourceOrNotDestination)

        twoOverlappingSquares(qPainter, GREEN, BLUE_50_ALPHA, COLUMN_3, ROW_3,
                              QtGui.QPainter.RasterOp_NotSourceXorDestination)

        twoOverlappingSquares(qPainter, GREEN, BLUE_50_ALPHA, COLUMN_1, ROW_4,
                              QtGui.QPainter.RasterOp_NotSource)

        twoOverlappingSquares(qPainter, GREEN, BLUE_50_ALPHA, COLUMN_2, ROW_4,
                              QtGui.QPainter.RasterOp_NotSourceAndDestination)

        twoOverlappingSquares(qPainter, GREEN, BLUE_50_ALPHA, COLUMN_3, ROW_4,

...
fn main() {
    let set1: HashSet<&str> = ["podporucik", "inspektor", "praktikant", "tovarnik"].iter().cloned().collect();
    let set2: HashSet<&str> = ["tovarnik", "stevard", "podkoni", "inspektor"].iter().cloned().collect();

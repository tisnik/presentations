...
// Ukazkovy priklad cislo 25.2
// Autor: Pavel Tisnovsky
//
// Vykresleni Juliovy verze Barnsleyovy fraktalni mnoziny J2.
...
#define WINDOW_TITLE    "Fraktaly 25.2"         // titulek okna
#define WINDOW_WIDTH    640                     // pocatecni velikost okna
#define WINDOW_HEIGHT   460
#define FILE_NAME       "fraktaly252.tga"       // jmeno souboru pro ulozeni pixmapy
...
//-----------------------------------------------------------------------------
// Prekresleni Mandelbrotovy verze Barnsleyovy fraktalni mnoziny M2
//-----------------------------------------------------------------------------
void recalcMandelbrotM2(pixmap *pix,            // pixmapa pro vykreslovani
...
//-----------------------------------------------------------------------------
// Prekresleni Juliovy verze Barnsleyovy fraktalni mnoziny J2
//-----------------------------------------------------------------------------
void recalcJuliaJ2(pixmap *pix,                 // pixmapa pro vykreslovani
                  int    maxiter,               // maximalni pocet iteraci
                  double scale,                 // meritko obrazce
                  double xpos,                  // posun obrazce
                  double ypos,
...
void onDisplay(void)
{
    ...
    if (ma) {                                   // pokud se ma prepocitat Mandelbrotova mnozina
        recalcMandelbrotM2(pixMandel, maxiter, scale, xpos, ypos, palette, rf, gf, bf);// prepocet fraktalu
        ma=0;
    }
    if (mb) {                                   // pokud se ma prepocitat Juliova mnozina
        recalcJuliaJ2(pixJulia, maxiter, scale, xpos, ypos, palette, rf, gf, bf, pcx, pcy);// prepocet fraktalu
        mb=0;
    }

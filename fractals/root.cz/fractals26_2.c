...
// Ukazkovy priklad cislo 26.2
// Autor: Pavel Tisnovsky
//
// Vykresleni Mandelbrotovy verze fraktalni mnoziny Magnet 1 s moznosti
...
#define WINDOW_TITLE    "Fraktaly 26.2"         // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME_1     "fraktaly262a.tga"      // jmeno souboru pro ulozeni pixmapy prvniho fraktalu
#define FILE_NAME_2     "fraktaly262b.tga"      // jmeno souboru pro ulozeni pixmapy druheho fraktalu
...
//-----------------------------------------------------------------------------
// Prekresleni fraktalni mnoziny Magnet 1 s moznosti nastaveni perturbace
//-----------------------------------------------------------------------------
void recalcMagnetM1P(pixmap *pix,               // pixmapa pro vykreslovani
...
void onDisplay(void)
{
    ...
    if (ma) {                                   // pokud se ma prepocitat levy fraktal
        recalcMagnetM1P(pixMandelA, maxiter, scale, xpos, ypos, 0.0, 0.0, palette, rf, gf, bf); // prepocet fraktalu
        ma=0;
    }
    ...
    if (mb) {                                   // pokud se ma prepocitat pravy fraktal
        recalcMagnetM1P(pixMandelB, maxiter, scale, xpos, ypos, pcx, pcy, palette, rf, gf, bf); // prepocet fraktalu
        mb=0;
    }

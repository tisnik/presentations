...
// Ukazkovy priklad cislo 25.3
// Autor: Pavel Tisnovsky
//
// Vykresleni Juliovy verze Barnsleyovy fraktalni mnoziny J3.
...
#define WINDOW_TITLE    "Fraktaly 25.3"         // titulek okna
#define WINDOW_WIDTH    640                     // pocatecni velikost okna
#define WINDOW_HEIGHT   460
#define FILE_NAME       "fraktaly253.tga"       // jmeno souboru pro ulozeni pixmapy
...
//-----------------------------------------------------------------------------
// Prekresleni Mandelbrotovy verze Barnsleyovy fraktalni mnoziny M3
//-----------------------------------------------------------------------------
void recalcMandelbrotM3(pixmap *pix,            // pixmapa pro vykreslovani
...
//-----------------------------------------------------------------------------
// Prekresleni Juliovy verze Barnsleyovy fraktalni mnoziny J3
//-----------------------------------------------------------------------------
void recalcJuliaJ3(pixmap *pix,                 // pixmapa pro vykreslovani
                  int    maxiter,               // maximalni pocet iteraci
                  double scale,                 // meritko obrazce
                  double xpos,                  // posun obrazce
                  double ypos,
...
void onDisplay(void)
{
    ...
    if (ma) {                                   // pokud se ma prepocitat Mandelbrotova mnozina
        recalcMandelbrotM3(pixMandel, maxiter, scale, xpos, ypos, palette, rf, gf, bf);// prepocet fraktalu
        ma=0;
    }
    if (mb) {                                   // pokud se ma prepocitat Juliova mnozina
        recalcJuliaJ3(pixJulia, maxiter, scale, xpos, ypos, palette, rf, gf, bf, pcx, pcy);// prepocet fraktalu
        mb=0;
    }

...
//
// Druhy demonstracni priklad na vypocet Markus-Lyapunovych fraktalu
//-----------------------------------------------------------------------------
...
int main(int argc, char **argv)
{
    ...
    recalcLyapunov(pix, 2, 500, 2.5, 2.0, 4.0, 3.0, "bbbbbaabaaa");    savePixmap(pix, "lyap1.tga");
    recalcLyapunov(pix, 4, 800, 0.0, 1.0, 4.0, 3.0, "aaaabbbb");      savePixmap(pix, "lyap2.tga");
    recalcLyapunov(pix, 5, 800, 1.0, 0.0, 4.0, 3.0, "aabaabaaabbab"); savePixmap(pix, "lyap3.tga");
    recalcLyapunov(pix, 8, 800, 2.5, 0.0, 4.0, 3.0, "bbba");          savePixmap(pix, "lyap4.tga");
    puts("\ndone!\n");

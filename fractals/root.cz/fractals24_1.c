...
// Ukazkovy priklad cislo 24.1
// Autor: Pavel Tisnovsky
//
// Vykresleni Barnsleyovy fraktalni mnoziny M1
...
#define WINDOW_TITLE    "Fraktaly 24.1"         // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly241.tga"       // jmeno souboru pro ulozeni pixmapy
...
//-----------------------------------------------------------------------------
// Prekresleni Barnsleyovy frakalni mnoziny M1
//-----------------------------------------------------------------------------
void recalcBarnsleyM1(pixmap *pix,              // pixmapa pro vykreslovani
...
void onDisplay(void)
{
    ...
    recalcBarnsleyM1(pix, maxiter, scale, xpos, ypos, palette, rf, gf, bf);// prepocet fraktalu

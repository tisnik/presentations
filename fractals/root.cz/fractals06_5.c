...
// Ukazkovy priklad cislo 6.5
// Autor: Pavel Tisnovsky
//
// Vykresleni dynamickeho systemu nazvaneho Chip.
...
#define WINDOW_TITLE    "Fraktaly 6.5"          // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly65.tga"        // jmeno souboru pro ulozeni pixmapy
...
//-----------------------------------------------------------------------------
void recalcChip(  pixmap *pix,                  // pixmapa pro vykreslovani
...
void onDisplay(void)
{
    ...
    recalcChip(pix, startx, starty, a, b, c, maxiter, scale, panx, pany); // prepocet fraktalu

...
// Ukazkovy priklad cislo 20.3
// Autor: Pavel Tisnovsky
//
// Vykresleni Mandelbrotovy mnoziny a Juliovy mnoziny s Z^4. Pohybem mysi
...
#define WINDOW_TITLE    "Fraktaly 20.3"         // titulek okna
#define WINDOW_WIDTH    640                     // pocatecni velikost okna
#define WINDOW_HEIGHT   440
#define FILE_NAME       "fraktaly203.tga"       // jmeno souboru pro ulozeni pixmapy
...
double pcx=0.0;                                 // hodnota pouzita pri generovani Juliovy mnoziny
double pcy=0.0;
...
{
    double zx, zy, zx2, zy2, zx4, zy4;          // slozky komplexni promenne Z, Z^2, Z^3 a Z^4
    double zxn, zyn;
    double cx, cy;                              // slozky komplexni konstanty C
    double zx0, zy0;
    double xmin, ymin, xmax, ymax;              // rohy vykreslovaneho obrazce v komplexni
...
void onDisplay(void)
{
    ...
    if (mb) {                                   // pokud se ma prepocitat Juliova mnozina
        recalcJulia(pixJulia, maxiter, scale, xpos, ypos, palette, rf, gf, bf, pcx, pcy);// prepocet fraktalu
        mb=0;
    }

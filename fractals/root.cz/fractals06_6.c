...
// Ukazkovy priklad cislo 6.6
// Autor: Pavel Tisnovsky
//
// Vykresleni dynamickeho systemu nazvaneho Quadruptwo.
...
#define WINDOW_TITLE    "Fraktaly 6.6"          // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly66.tga"        // jmeno souboru pro ulozeni pixmapy
...
double startx=0.0;                              // pocatecni podminky
double starty=0.0;
double a=-15, b=-19, c=1;                       // parametry fraktalu
//double a=34, b=1, c=5;                       // parametry fraktalu
int    maxiter=30000;                           // maximalni pocet iteraci
double scale=88;                                // meritko fraktalu
double panx=325;                                // posun fraktalu
double pany=185;                                // posun fraktalu
...
double sgn(double x) {if (x<0) return -1.0; if (x>0) return 1.0; return 0.0;}
double sqr(double x) {return x*x;}

//-----------------------------------------------------------------------------
// Prekresleni dynamickeho systemu
//-----------------------------------------------------------------------------
void recalcQuadruptwo(pixmap *pix,              // pixmapa pro vykreslovani
...
void onDisplay(void)
{
    ...
    recalcQuadruptwo(pix, startx, starty, a, b, c, maxiter, scale, panx, pany); // prepocet fraktalu

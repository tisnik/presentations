...
// Ukazkovy priklad cislo 23.2
// Autor: Pavel Tisnovsky
//
// Vykresleni Newtonovy fraktalni mnoziny pro reseni polynomu z^3-1=0 modifikovanou
// metodou spolu se zvyraznenim korenu, ke kteremu reseni speje.
...
#define WINDOW_TITLE    "Fraktaly 23.2"         // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly232.tga"       // jmeno souboru pro ulozeni pixmapy
...
//-----------------------------------------------------------------------------
// Prekresleni Newtonovy fraktalni mnoziny pro polynom z^3-1=0 modifikovanou
// metodou kombinovanou se zvyraznenim korenu, ke kterym reseni konverguje
//-----------------------------------------------------------------------------
...
void onDisplay(void)
{
    ...
    recalcNewton(pix, maxiter, scale, xpos, ypos, palette, rf, gf, bf);// prepocet fraktalu

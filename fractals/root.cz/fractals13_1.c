...
// Ukazkovy priklad cislo 13.1
// Autor: Pavel Tisnovsky
//
// Vykresleni cernobile Mandelbrotovy mnoziny. Pixely, ktere se nachazi uvnitr
// Mandelbrotovy mnoziny, jsou vykresleny bilou barvou, pixely, ktere se
// nachazi vne, barvou cernou.
...
#define WINDOW_TITLE    "Fraktaly 13.1"         // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   512
#define FILE_NAME       "fraktaly131.tga"       // jmeno souboru pro ulozeni pixmapy
...
int    maxiter=20;                              // maximalni pocet iteraci
                  ...
                  int    maxiter)               // maximalni pocet iteraci
{
    ...
    for (y=0; y<pix->height; y++) {             // pro vsechny radky v pixmape
        ...
        for (x=0; x<pix->width; x++) {          // pro vsechny pixely na radku
            ...
            color=(iter==maxiter) ? 255 : 0;    // vypocitat barvu pixelu

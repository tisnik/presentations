...
// Ukazkovy priklad cislo 6.1
// Autor: Pavel Tisnovsky
//
// Vykresleni Henonova atraktoru.
...
#define WINDOW_TITLE    "Fraktaly 6.1"          // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly61.tga"        // jmeno souboru pro ulozeni pixmapy
...
double starty=0.0;
double a=1.4, b=0.3;                            // parametry fraktalu
...
//-----------------------------------------------------------------------------
void recalcHenon(pixmap *pix,                   // pixmapa pro vykreslovani
...
void onDisplay(void)
{
    ...
    recalcHenon(pix, startx, starty, a, b, maxiter, scale, panx, pany); // prepocet fraktalu

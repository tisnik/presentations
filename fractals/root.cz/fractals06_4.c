...
// Ukazkovy priklad cislo 6.4
// Autor: Pavel Tisnovsky
//
// Vykresleni dynamickeho systemu nazvaneho Hopalong.
...
#define WINDOW_TITLE    "Fraktaly 6.4"          // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly64.tga"        // jmeno souboru pro ulozeni pixmapy
...
double starty=0.05;
double a=0.4, b=1.0, c=0;                       // parametry fraktalu
...
//-----------------------------------------------------------------------------
void recalcHopalong(pixmap *pix,                // pixmapa pro vykreslovani
...
void onDisplay(void)
{
    ...
    recalcHopalong(pix, startx, starty, a, b, c, maxiter, scale, panx, pany); // prepocet fraktalu

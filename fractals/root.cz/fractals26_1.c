...
// Ukazkovy priklad cislo 26.1
// Autor: Pavel Tisnovsky
//
// Vykresleni Mandelbrotovy verze fraktalni mnoziny Magnet 1.
...
#define WINDOW_TITLE    "Fraktaly 26.1"         // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly261.tga"       // jmeno souboru pro ulozeni pixmapy
...
//-----------------------------------------------------------------------------
// Prekresleni Mandelbrotovy verze fraktalni mnoziny Magnet 1
//-----------------------------------------------------------------------------
...
void onDisplay(void)
{
    ...
    recalcMagnetM1(pix, maxiter, scale, xpos, ypos, palette, rf, gf, bf);// prepocet fraktalu

...
// Ukazkovy priklad cislo 15.4
// Autor: Pavel Tisnovsky
//
// Vykresleni Mandelbrotovy mnoziny s moznosti zmeny pohledu na mnozinu a
// zmeny pouzite barvove palety. Body vne mnoziny jsou obarveny na zaklade
// souctu realne a imaginarni slozky orbitu.
...
#define WINDOW_TITLE    "Fraktaly 15.4"         // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly154.tga"       // jmeno souboru pro ulozeni pixmapy
...
double scale=124.04;                            // meritko fraktalu
double xpos=-0.014;                             // posun fraktalu
double ypos=-0.714;                             // posun fraktalu

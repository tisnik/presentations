...
// Ukazkovy priklad cislo 7.2
// Autor: Pavel Tisnovsky
//
// Vykresleni dynamickeho systemu nazvaneho Pickover.
...
#define WINDOW_TITLE    "Fraktaly 7.2"          // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly72.tga"        // jmeno souboru pro ulozeni pixmapy
...
//-----------------------------------------------------------------------------
void recalcPickover(pixmap *pix,                // pixmapa pro vykreslovani
...
void onDisplay(void)
{
    ...
    recalcPickover(pix, a, b, c, d, maxiter, scale, panx, pany); // prepocet fraktalu

...
// Ukazkovy priklad cislo 9.3
// Autor: Pavel Tisnovsky
//
// Vykresleni modifikovaneho Lorenzova atraktoru v prostoru
...
#define WINDOW_TITLE    "Fraktaly 9.3"          // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384

double a=10.0;                                  // parametry fraktalu
double b=28.0;
double c=2.66;
double dt=0.02;
...
//-----------------------------------------------------------------------------
// Prekresleni modifikovaneho Lorenzova atraktoru
//-----------------------------------------------------------------------------
void recalcLorenz3(   double a,                 // parametry fraktalu
                      double b,
                      double c,
...
{
    double x=1.0, y=1.0, z=1.0;                 // pocatecni pozice bodu
    double x2, y2, z2;
    double norm;
    int iter=maxiter;
    ...
    while (iter--) {                            // iteracni smycka
        ...
        y=y2;
        z=z2;
        glVertex3d((x+0.35)*scale, (y+1.5)*scale, (z-8.0)*scale);
    }
    glEnd();
}
...
void onDisplay(void)
{
    ...
    glPushMatrix();
        ...
        recalcLorenz3(a, b, c, dt, maxiter, scale); // prepocet fraktalu
    glPopMatrix();

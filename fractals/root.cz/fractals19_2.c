...
// zaklade realne slozky orbitu a poctu iteraci.
...
#define WINDOW_TITLE    "Fraktaly 19.2"         // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly192.tga"       // jmeno souboru pro ulozeni pixmapy

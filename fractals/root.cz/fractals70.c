...
//
// Demonstracni priklad na vypocet rozsirenych Markus-Lyapunovych fraktalu
//-----------------------------------------------------------------------------
...
#define PIXMAP_HEIGHT   240                     // vyska pixmapy
    ...
    for (y=0; y<pix->height; y++) {
        ...
        for (x=0; x<pix->width; x++) {
            ...
            if (total<0) {                      // obarvit pixely se zapornym exponentem
                ...
                mapPalette(palette, -total, &r, &g, &b);
...
#define RND(n) rand()%(n)
    ...
    strcpy(str, "aadb");     recalcLyapunov(pix, 8, 500, 0.0, 0.0, 4.0, 3.0, str); strcat(str, ".tga"); savePixmap(pix, str);
    strcpy(str, "aamb");     recalcLyapunov(pix, 2, 500, 0.0, 0.0, 4.0, 3.0, str); strcat(str, ".tga"); savePixmap(pix, str);
    strcpy(str, "xxmnsn");   recalcLyapunov(pix, 1, 500, 0.5, 0.5, 3.5, 2.5, str); strcat(str, ".tga"); savePixmap(pix, str);
    strcpy(str, "xotogbg");  recalcLyapunov(pix, 4, 500, 0.5, 0.5, 4.0, 3.0, str); strcat(str, ".tga"); savePixmap(pix, str);
    strcpy(str, "abfb");     recalcLyapunov(pix, 2, 500, 0.0, 0.0, 4.0, 3.0, str); strcat(str, ".tga"); savePixmap(pix, str);
    strcpy(str, "bhawdy");   recalcLyapunov(pix, 8, 500, 1.0, 1.0, 3.5, 2.5, str); strcat(str, ".tga"); savePixmap(pix, str);
    strcpy(str, "psfadp");   recalcLyapunov(pix, 8, 500, 0.0, 0.0, 4.0, 3.0, str); strcat(str, ".tga"); savePixmap(pix, str);
    strcpy(str, "wgbusbmb"); recalcLyapunov(pix, 9, 500, 2.0, 1.5, 3.5, 2.5, str); strcat(str, ".tga"); savePixmap(pix, str);
    /*
    for (i='a'; i<='z'; i++) {
        int palette=RND(10);
        str[0]='a';

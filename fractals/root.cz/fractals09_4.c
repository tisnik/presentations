...
#define WINDOW_TITLE    "Fraktaly 9.4"          // titulek okna
...
//-----------------------------------------------------------------------------
void recalcLorenz4(   double a,                 // parametry fraktalu
                      double b,
                      double c,
...
void onDisplay(void)
{
    ...
    glPushMatrix();
        ...
        recalcLorenz4(a, b, c, dt, maxiter, scale); // prepocet fraktalu
    glPopMatrix();

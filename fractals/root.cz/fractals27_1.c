...
// Ukazkovy priklad cislo 27.1
// Autor: Pavel Tisnovsky
//
// Vykresleni Mandelbrotovy verze fraktalni mnoziny Magnet 2.
...
#define WINDOW_TITLE    "Fraktaly 27.1"         // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly271.tga"       // jmeno souboru pro ulozeni pixmapy
...
//-----------------------------------------------------------------------------
// Prekresleni Mandelbrotovy verze fraktalni mnoziny Magnet 2
//-----------------------------------------------------------------------------
...
void onDisplay(void)
{
    ...
    recalcMagnetM2(pix, maxiter, scale, xpos, ypos, palette, rf, gf, bf);// prepocet fraktalu

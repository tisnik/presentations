...
// Demonstracni priklad 53.1
// Autor: Pavel Tisnovsky
//
// Vykresleni krivky Helge von Kocha (Koch Curve) pomoci L-systemu.
...
#define WINDOW_TITLE    "Fraktaly 53.1"         // titulek okna
...
double ypos=10.0;
char   ret[MAX_LENGTH]="F";                     // pocatecni symbol

...
// Ukazkovy priklad cislo 24.3
// Autor: Pavel Tisnovsky
//
// Vykresleni Barnsleyovy fraktalni mnoziny M3
...
#define WINDOW_TITLE    "Fraktaly 24.5"         // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly245.tga"       // jmeno souboru pro ulozeni pixmapy
...
//-----------------------------------------------------------------------------
// Prekresleni Barnsleyovy frakalni mnoziny M3
//-----------------------------------------------------------------------------
void recalcBarnsleyM3(pixmap *pix,              // pixmapa pro vykreslovani
...
void onDisplay(void)
{
    ...
    recalcBarnsleyM3(pix, maxiter, scale, xpos, ypos, palette, rf, gf, bf);// prepocet fraktalu

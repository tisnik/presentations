...
#define WINDOW_TITLE    "Fraktaly 11.2"         // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly112.tga"       // jmeno souboru pro ulozeni pixmapy
...
void drawInfo(int maxiter, double xpos, double ypos, double scale)
{
    ...
    drawString(10, 48, 0.9, 1.0, 0.2, str);
    sprintf(str, "[PgUp][PgDn]  scale = %4.2f ", scale);
    drawString(10, 32, 0.6, 1.0, 0.6, str);
...
void onDisplay(void)
{
    ...
    recalcJulia(pix, maxiter, scale, xpos, ypos);// prepocet fraktalu

...
// Ukazkovy priklad cislo 28.1
// Autor: Pavel Tisnovsky
//
// Vykresleni Mandelbrotovy verze fraktalni mnoziny typu Phoenix.
...
#define WINDOW_TITLE    "Fraktaly 28.1"         // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly281.tga"       // jmeno souboru pro ulozeni pixmapy
...
//-----------------------------------------------------------------------------
// Prekresleni Mandelbrotovy verze fraktalni mnoziny typu Phoenix
//-----------------------------------------------------------------------------
...
void onDisplay(void)
{
    ...
    recalcPhoenixM(pix, maxiter, scale, xpos, ypos, palette, rf, gf, bf);// prepocet fraktalni mnoziny Phoenix

...
// Bod x(n) je vybiran na zaklade pravdepodobnosti jednotlivych transformaci.
//-----------------------------------------------------------------------------
...
{                                                 
    ...
    while (iter++<maxiter*100) {                    // iteracni smycka
        ...
        // nalezeni jedne transformace pro dalsi iteraci
        // na zaklade pravdepodobnosti jednotlivych transformaci

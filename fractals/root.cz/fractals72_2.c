...
int main(int argc, char **argv)
{
    ...
    // vytvorit celkem deset rastrovych obrazku
    for (i=0; i<10; i++) {
        char str[100];
        // generovani jmena souboru
        sprintf(str, "perlin%02d.tga", i);
        printf("generuji obrazek %s...", str);
        // zmena barvove palety a koeficientu "n"
        recalcPerlinNoise2D(pix, i%10, -mez, -mez, mez, mez, 2, 2, i);
        savePixmap(pix, str);
        printf("   hotovo\n");
    }
    return 0;

...
#define WINDOW_TITLE    "Fraktaly 13.4"         // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly134.tga"       // jmeno souboru pro ulozeni pixmapy
                  ...
                  double ypos)
{
    ...
    for (y=0; y<pix->height; y++) {             // pro vsechny radky v pixmape
        ...
        for (x=0; x<pix->width; x++) {          // pro vsechny pixely na radku
            ...
            putpixel(pix, x, y, 127+127.0*sin(iter/30.0), iter*20.0, 127+127.0*sin(iter/10.0)); // vykresleni pixelu
...
void onDisplay(void)
{
    ...
    recalcMandelbrot(pix, maxiter, scale, xpos, ypos);// prepocet fraktalu

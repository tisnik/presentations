...
// Ukazkovy priklad cislo 24.2
// Autor: Pavel Tisnovsky
//
// Vykresleni Barnsleyovy fraktalni mnoziny M2
...
#define WINDOW_TITLE    "Fraktaly 24.2"         // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly242.tga"       // jmeno souboru pro ulozeni pixmapy
...
//-----------------------------------------------------------------------------
// Prekresleni Barnsleyovy frakalni mnoziny M2
//-----------------------------------------------------------------------------
void recalcBarnsleyM2(pixmap *pix,              // pixmapa pro vykreslovani
...
void onDisplay(void)
{
    ...
    recalcBarnsleyM2(pix, maxiter, scale, xpos, ypos, palette, rf, gf, bf);// prepocet fraktalu

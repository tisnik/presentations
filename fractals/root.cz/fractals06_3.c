...
// Ukazkovy priklad cislo 6.3
// Autor: Pavel Tisnovsky
//
// Vykresleni dynamickeho systemu nazvaneho Gingerbreadman.
...
#define WINDOW_TITLE    "Fraktaly 6.3"          // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly63.tga"        // jmeno souboru pro ulozeni pixmapy
...
//-----------------------------------------------------------------------------
void recalcGinger(pixmap *pix,                  // pixmapa pro vykreslovani
...
void onDisplay(void)
{
    ...
    recalcGinger(pix, startx, starty, maxiter, scale, panx, pany); // prepocet fraktalu

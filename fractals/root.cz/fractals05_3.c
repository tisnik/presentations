...
#define WINDOW_TITLE    "Fraktaly 5.3"          // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly5.tga"         // jmeno souboru pro ulozeni pixmapy
...
double x0=0.28;                                 // uroven populace v nultem kroku
int    yp=0;                                    // posun diagramu nahoru ci dolu
double gr0=-2.0;                                // posun populacniho rustu
int    maxiter=100;                             // maximalni pocet iteraci
int    iter0=0;                                 // mez v poctu iteraci, od ktere se zacne s vykreslovanim

...
#define WINDOW_TITLE    "Fraktaly 17.3"         // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME_1     "fraktaly173a.tga"      // jmeno souboru pro ulozeni pixmapy nezkreslene Mandelbrotovy mnoziny
#define FILE_NAME_2     "fraktaly173b.tga"      // jmeno souboru pro ulozeni pixmapy zkreslene Mandelbrotovy mnoziny
...
//-----------------------------------------------------------------------------
// Vypocet druhe mocniny vzdalenosti dvou bodu
//-----------------------------------------------------------------------------

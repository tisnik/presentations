...
#define WINDOW_TITLE    "Fraktaly 19.1"         // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly191.tga"       // jmeno souboru pro ulozeni pixmapy

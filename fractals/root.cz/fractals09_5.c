...
// Ukazkovy priklad cislo 9.5
// Autor: Pavel Tisnovsky
//
// Vykresleni Rosslerova atraktoru v prostoru
...
#define WINDOW_TITLE    "Fraktaly 9.5"          // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384

double a=0.2;                                   // parametry fraktalu
double b=0.2;
double c=5.7;
double dt=0.04;
...
//-----------------------------------------------------------------------------
void recalcRossler(   double a,                 // parametry fraktalu
                      double b,
                      double c,
...
{
    double x=1.0, y=1.0, z=1.0;                 // pozice bodu
    double x2, y2, z2;
    int iter=maxiter;
...
void onDisplay(void)
{
    ...
    glPushMatrix();
        ...
        recalcRossler(a, b, c, dt, maxiter, scale); // prepocet fraktalu
    glPopMatrix();

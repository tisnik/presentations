...
// Ukazkovy priklad cislo 7.4
// Autor: Pavel Tisnovsky
//
// Vykresleni dynamickeho systemu nazvaneho Kamtorus 3D.
...
#define WINDOW_TITLE    "Fraktaly 7.4"          // titulek okna
...
double scale=4;                                 // meritko fraktalu
...
//-----------------------------------------------------------------------------
void recalcKamtorus3D(double start,             // pocatecni a koncova
...
//-----------------------------------------------------------------------------
void drawInfo(double start, double end, double step, double alpha, int maxiter, double scale)
{
    char str[100];
...
void onDisplay(void)
{
    ...
    glPushMatrix();
        ...
        recalcKamtorus3D(start, end, step, alpha, maxiter, scale); // prepocet fraktalu
    glPopMatrix();
    ...
    glPushMatrix();
        ...
        drawInfo(start, end, step, alpha, maxiter, scale);
    glPopMatrix();

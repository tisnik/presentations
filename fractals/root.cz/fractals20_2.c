...
// Ukazkovy priklad cislo 20.2
// Autor: Pavel Tisnovsky
//
// Vykresleni Mandelbrotovy mnoziny se ctvrtou mocninou hodnoty Zn s moznosti
// zmeny pohledu na mnozinu a zmeny pouzite barvove palety.
...
#define WINDOW_TITLE    "Fraktaly 20.2"         // titulek okna
#define WINDOW_WIDTH    512                     // pocatecni velikost okna
#define WINDOW_HEIGHT   384
#define FILE_NAME       "fraktaly202.tga"       // jmeno souboru pro ulozeni pixmapy

/* OpenVG (nejenom) na Raspberry Pi - osmnacty demonstracni priklad */
/* Vytvoreni screenshotu obrazovky - pouziti 32bitoveho formatu TGA (Targa). */
/* Pouziti funkce vgReadPixels */
...
int main(int argc, char *argv[])
{
    ...
    /* vytvoreni screenshotu */
    makeScreenshot(&egl_state, "example18.tga");
    getchar();
